...
boxplot(ale_beer_houses_per_100k, 
        attendants_public_school_per_100k, 
        attendants_public_worship_per_100k, 
...
factor_colors <- c("red", "blue", "green", "orange", "purple", "yellow", "pink", "magenta", "cyan")
...
par(mfrow=c(1,3))
boxplot(subset_data$ale_beer_houses_per_100k ~ subset_data$region_code, main = "", col = factor_colors)
boxplot(subset_data$attendants_public_school_per_100k ~ subset_data$region_code, main = "", col = factor_colors)
boxplot(subset_data$attendants_public_worship_per_100k ~ subset_data$region_code, main = "", col = factor_colors)
```
