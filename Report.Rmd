...
boxplot(subset_data$attendants_public_school_per_100k ~ subset_data$region_code, main = "", col = factor_colors, xlab = "Region code")
boxplot(subset_data$attendants_public_worship_per_100k ~ subset_data$region_code, main = "", col = factor_colors, xlab ="Region code")
```
...
plot(criminals_per_100k~attendants_public_worship_per_100k)
