...
colnames(data) <- c("county", "region_name", "region_code", "criminals_per_100k", "ale_beer_houses_per_100k", "attendants_public_school_per_100k", "attendants_public_worship_per_100k")
